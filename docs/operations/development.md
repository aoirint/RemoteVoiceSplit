...
dotnet run --project RemoteVoiceSplit.Tests --no-build -c Debug -- RemoteVoiceSplit/bin/Debug/netstandard2.1/RemoteVoiceSplit.dll RemoteVoiceSplit.AudioHost/bin/Debug/net48/RemoteVoiceSplit.AudioHost.exe 0.1.0-alpha.1 0.1.0-alpha.1
