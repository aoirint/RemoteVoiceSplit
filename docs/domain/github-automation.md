...
headroom but no Windows runtime. A separate job smoke-tests the Windows-targeted
test executable and both managed outputs on the oldest supported GA Windows
image. All harness cases are deterministic and require no audio endpoint.
