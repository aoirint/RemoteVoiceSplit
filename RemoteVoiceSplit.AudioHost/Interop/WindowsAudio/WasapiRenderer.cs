...
namespace RemoteVoiceSplit.AudioHost.Interop.WindowsAudio;
...
internal sealed class WasapiRenderer : IDisposable
{
    ...
    public static WasapiRenderer Open(PcmAudioBuffer buffer, string endpointId, int sampleRate)
    {
        ...
        try
        {
            ...
            renderer = new WasapiRenderer(buffer, renderEvent, audioClient, renderClient, device, bufferFrameCount, resolvedEndpointId);
            renderEvent = null;
            audioClient = null;
            renderClient = null;
            device = null;
    ...
    public void Render()
    {
        ...
        bool hasAudio = _buffer.Read(_mixBuffer, sampleCount);
